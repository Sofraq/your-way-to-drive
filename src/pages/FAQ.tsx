...
const FAQ = () => {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Стандартний курс триває 1-1,5 місяця. Теоретична частина займає близько 1 місяць (40 годин), практична частина залежить від вас і кількості уроків з інструктором, але в середньому займає 2-4 тижні (25-30 годин залежно від обраного курсу). Темп навчання ви можете регулювати самостійно, особливо теоретичну частину.",
    },
    {
