...
const About = () => {
  const stats = [
    { icon: <Users className="h-8 w-8" />, value: "1,200+", label: "Випускників" },
    { icon: <Award className="h-8 w-8" />, value: "7+", label: "Років досвіду" },
    { icon: <Car className="h-8 w-8" />, value: "30+", label: "Нових авто" },
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground">
                Ми — сучасна автошкола з 7-річним досвідом підготовки водіїв. 
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-muted-foreground">
                <p>
                  Наша автошкола була заснована в 2017 році з простою, але важливою місією — 
                  навчати людей безпечному водінню та допомагати їм отримувати водійські права 
                  з першого разу.
                </p>
                
                <p>
                  За роки роботи ми підготували понад 1,200 водіїв, які впевнено почуваються 
