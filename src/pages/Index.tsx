          ...
          <div className="container relative z-10">
            <div className="max-w-2xl space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Навчайтеся на нашій сучасній онлайн-платформі: інтерактивні уроки, 
                відеолекції у високій якості, тести для самоперевірки — все це доступно 
                24/7 з будь-якого пристрою. Комфортне навчання у власному темпі!
              </p>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">вул. Хрещатик, 15 (центр міста)</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">вул. Донець-Захаржевського, 5</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">вул. Глінки, 2 (ТРЦ "Мост Сіті")</p>
                  </div>
                </CardContent>
              </Card>
